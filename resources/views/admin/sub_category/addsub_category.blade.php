...
<form method="post" action="{{URL::to('post_subcategory')}}" enctype="multipart/form-data">
   ...
   <div class="add-section_block">            
                      ...
                      <option value="">Select Categories</option>
                         <?php foreach($all_category  as $data)   {?>                            
                            <option value="{{$data->news_id}}">{{$data->category_name}}</option> 
                         <?php     }?> 
...
<label><h4>Category Update Date :</h4></label>
<input type="text" class="form-control" name="update_date" placeholder="Enter Date" required><br>

<label><h4>Category Image</h4></label>
