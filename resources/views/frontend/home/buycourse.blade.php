                        ...
                        <div class="row g-3">
                            <div class="col-sm-12">
                                <div class="form-floating">
                                    <input id="name" type="text" class="form-control border-0 bg-light"  placeholder="Name" name="name" type="text" required autofocus>
                                    <label for="gname">Your Name</label>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-floating">
                                    <input id="number" maxlength="10" name="number"  class="form-control border-0 bg-light"id="number" placeholder="Phone Number"  type="number" required>                                   
                                    <label for="gmail">Your Phone Number</label>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-floating">
                                    <input class="form-control border-0 bg-light" placeholder="Your Email Address" id="email" name="email" class="form-control" type="email" required>
